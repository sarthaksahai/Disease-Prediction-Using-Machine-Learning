...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r"C:\Users\Sarthak Sahai\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r"C:\Users\Sarthak Sahai\Testing.csv")
...
w2 = Label(root, justify=CENTER, text="A Project by Sarthak sahai", fg="white", bg="blue")
